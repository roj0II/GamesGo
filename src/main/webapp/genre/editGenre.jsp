...
<body>
    <div class="container">
        <div class="header-buttons">
            <a href="/genre/" class="btn btn-primary"><i class="fas fa-arrow-left"></i> Indietro</a>
            <div class="icons">
	            <i class="fa-solid fa-mars-and-venus fa-2xl"></i>
	         </div>   
	            <h1 class="header-title">Modifica Genere</h1>
	    ...
	    <table class="table table-striped">
	        <thead>
	            <tr>
	                <td>Name<f:input path="id" type="hidden"/></td>
